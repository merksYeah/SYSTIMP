...
<%
      String currentApp = "/ToInProcessOrders";
%>
          ...
          <section class="wrapper">
          	<div class="row mt">
                    <div class="col-lg-12">
                        ...
                        <div class="panel-heading"><h3>Orders being Processed For Delivery</h3></div>
                          ...
                          <table id = "what" class="table table-bordered table-striped table-condensed">
                              ...
                              <tbody>
                                  <c:forEach items="${orders}" var="SalesOrder">
                                   <tr>
                                          <td>
                                            <input  type="radio" name="radios" value="<c:out value="${SalesOrder.order_id}"/>">
                                          </td>
      ...
      function noSunday(date){
          var day = date.getDay();
             ...
             $('#proceed').click(function(){
                 ...
                 //alert(orderid);
                    $('#message').text("Update Sales Order: " + orderid +" to delivered?");
            });
            ...
            .done(function(  ) {
               ...
               $("#endMessage").text("ORDER SUCCESSFULLY UPDATED TO DELIVERED!");
               $("#message2").modal('show');
