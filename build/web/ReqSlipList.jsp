          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
          		<div class="col-lg-12">
                    ...
                    <div class="panel-heading"><h3>Purchase Order List</h3></div>
                              ...
                              <tbody>
                                  <c:forEach items="${orders}" var="PurchaseOrder">
                                   <tr>
                                          ...
                                          <td><c:out value="${PurchaseOrder.date_delivered}"/></td>
                                           <c:choose>
                                    <c:when test="${PurchaseOrder.status eq 'In Process For Delivery'}">
                                      ...
                                      <c:when test="${PurchaseOrder.status eq 'Delivered'}">
                                        <td><span class="label label-success">DELIVERED</span></td>
                                    </c:when>
                                    <c:when test="${PurchaseOrder.status eq 'For Reordering'}">
