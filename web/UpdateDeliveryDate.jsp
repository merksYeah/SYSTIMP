...
<%
        String currentApp = "/ViewUpdateDeliveryDate";
%>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Update Delivery Date of Order</h3>
                  ...
                  <div class="form-panel">
                          ...
                          <form id="create" action = "UpdateDeliveryDate" class="form-horizontal style-form" method="post"> 
                            ...
                            <div class ="form-group" >
                                <label class="col-lg-2 col-sm-2 control-label">New Delivery Date</label>
                                <div class = col-lg-2>
                                                        ...
                                                        <hr>
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="hidden-phone"><i class="fa fa-question-circle"></i> Quantity Ordered</th>
