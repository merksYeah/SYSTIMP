 ...
 * @author deathman28
 */
public class ViewUpdatePOList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<PurchaseOrder> orders = poDB.getPurchaseOrderForUpdating();
            request.setAttribute("orders",orders);
            rd = request.getRequestDispatcher("UpdatePurchaseOrderStatus.jsp");
