 ...
 * @author deathman28
 */
public class LoadDeliverySchedule extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<FullCalendar> calendar = new ArrayList<FullCalendar>();
            FullCalendar c = new FullCalendar();
            ...
            calendar = salesDB.getCustomerCalendar(cust);
            }
                ...
                calendar = salesDB.getSalesAgentCalendar(emp);
            }
            else{
                calendar = salesDB.getPlantManagerCalendar();
            }
