 ...
 * @author deathman28
 */
public class ToUpdateDeliveredOrders extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<Product> products = soDB.getInProcessOrderDetails(so);
            request.setAttribute("products",products);
            request.setAttribute("order",so);
            rd = request.getRequestDispatcher("UpdateDeliveredOrders.jsp");
