 ...
 * @author deathman28
 */
public class ViewReqSlipList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<PurchaseOrder> orders = poDB.getAllPurchaseOrder();
            request.setAttribute("orders",orders);
            rd = request.getRequestDispatcher("ReqSlipList.jsp");
