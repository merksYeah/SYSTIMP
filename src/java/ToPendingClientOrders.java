 ...
 * @author deathman28
 */
public class ToPendingClientOrders extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<SalesOrder> orders = db2.getSalesOrdersBySalesAgent(emp, cs, so);
            request.setAttribute("orders",orders);
            
              
            rd = request.getRequestDispatcher("/PendingClientOrders.jsp");
