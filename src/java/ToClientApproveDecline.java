 ...
 * @author deathman28
 */
public class ToClientApproveDecline extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            CustomerDAO db4 = db.getCustomerDAO();
            ArrayList<Customer> customer = db4.getFilteredCustomerPerAgent(emp);
            ...
            rd = request.getRequestDispatcher("/ApproveClient.jsp");
