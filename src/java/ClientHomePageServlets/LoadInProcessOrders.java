 ...
 * @author deathman28
 */
@WebServlet(name = "LoadInProcessOrders", urlPatterns = {"/LoadInProcessOrders"})
public class LoadInProcessOrders extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           SalesOrderDAO salesDB = db.getSalesOrderDAO();
            ...
            orders = salesDB.getNonDeliveredOrders(so,cust);
            }
                ...
                emp = empDB.getEmployeeById(emp);
                 so.setStatusCode(request.getParameter("orderstatus"));
                  orders = salesDB.getNonDeliveredOrdersSalesAgent(so,emp);
            }
