 ...
 * @author deathman28
 */
public class ViewPriceModel extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(request.getParameter("code").equals("A")){
            rd = request.getRequestDispatcher("ViewPriceModelA.jsp");
            rd.forward(request,response);
            }
            else{
                rd = request.getRequestDispatcher("ViewPriceModelI.jsp");
            rd.forward(request,response);
            }
        }
    }
