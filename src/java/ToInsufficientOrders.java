 ...
 * @author deathman28
 */
public class ToInsufficientOrders extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        CustomerDAO custDB = db.getCustomerDAO();
        ...
        cust = custDB.getCustomerOrderDetails(cust);
        so.setStatusCode("S");
        ArrayList<SalesOrder> orders = salesDB.getSalesOrdersByCustomer(cust, so);
        
        request.setAttribute("orders",orders);
        rd = request.getRequestDispatcher("InsufficientStockOrders.jsp");
